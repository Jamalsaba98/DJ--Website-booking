...
$query->bindParam(':msg',$msg,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("הודעה נשלחה בהצלחה,נחזור בהקדם האפשאי תודה ")</script>';
